...
if ($hasRight && isset($_REQUEST['sym']))
{
    $priCoName = trim($_REQUEST['sym']);
    $stock = $stockController->FindStockBySym($priCoName);
...
if ($hasRight && isset($_POST['submit'])) {
    ...
    $priCoName = trim($_REQUEST['sym']);
    header('location:stock_review.php?sym=' .trim($_REQUEST['sym']));
...
<script language="javascript" type="text/javascript">
 function _infor(id,catagory)
    ...
    function editSymInfo(symInfoId)
    {
         ...
         $.ajax({
            type: "POST",
            url: "ajax_edit_sym_info.php?symInfoId=" + symInfoId,
            success: function (result) 
            {                          
    ...
    {        
        ...
        $.ajax({
            type: "POST",
            url: "ajax_save_sym_info.php?sym=" + priCoName,
            data: formData,
            success: function (result) 
            {
    ...
    function editCoInfor(coInfoId, coSymName)
    {
        ...
        window.location = "test_ajax_edit_co_description.php?id=" + coInfoId
